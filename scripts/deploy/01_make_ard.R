...
spectral <- read.csv(paste0(data_dir, "input/spectral_", fileap, ".csv"))
...
write.csv(ard, paste0(data_dir, "saved/ARD_", fileap, ".csv"), row.names = FALSE)
...
terra::writeVector(ardcoords, paste0(data_dir, "saved/ARD_", fileap, ".gpkg"))
